		...
		<div class="w main">
			<form id="frm_login" method="post" action="../emp/doLogin">
				...
				<div class="ui-btn-wrap">
					<input name="" type="submit" value="用户登录"
						class="ui-btn-lg ui-btn-primary" />
				</div>
				<div class="ui-btn-wrap">
					<a class="ui-btn-lg ui-btn-danger" href="register.html">没有账号？立即注册</a>
				</div>
				<div class="item item-login-other">
					<dl>
						<dt>其它登录方式</dt>
						<dd>
							<a class="qq" href="#"> <span><img alt=""
									src="../images/login_qq.png" width="40" height="40"></span>
							</a>
						</dd>
					</dl>
				</div>
